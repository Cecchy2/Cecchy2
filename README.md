...
Sono uno sviluppatore, oggi lavoro per **Smartwage** come **Frontend** e per **Ristonic** come **Full Stack**.  
...
- Mi occupo di **integrazione API**, **gestione stato** e attenzione alla **user experience**
- Continuo a costruire progetti personali per crescere in modo concreto

---

## 🛠️ Stack che uso più spesso
...
- Portfolio: **[www.dariocecchinato.com](https://www.dariocecchinato.com)**
